...
In this lab, I am sharing how to build a simple adaptive card with choiceset control to display a list of dynamic values for selection. Here we go! Dynamic means the values are different based on different scenario. It is a pre-defined static list of value.
